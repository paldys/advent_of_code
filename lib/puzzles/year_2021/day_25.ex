defmodule AdventOfCode.Puzzles.Year2021.Day25 do
  @moduledoc """
  --- Day 25: Sea Cucumber ---
  ...
  completely covered by two large herds of sea cucumbers, and there isn't
  ...
  forward one location. When a herd moves forward, every sea cucumber
  in the herd first simultaneously considers whether there is a sea cucumber
  in the adjacent location it's facing (even another sea cucumber facing
  the same direction), and then every sea cucumber facing an empty location
  ...
  sea cucumber has moved (as it wasn't out of the way in time for
  the east-facing cucumber on the left to move), but both sea cucumbers
  on the right have moved (as the east-facing sea cucumber moved out of the way
  ...
  the right edge of the map appear on the left edge, and sea cucumbers that move
