defmodule AdventOfCode.Puzzles.Year2021.Day22Test do
  use ExUnit.Case
  ...
  test "parse input" do
    ...
    assert AdventOfCode.Puzzles.Year2021.Day22.parse(test_input) == @test_steps_small
  end

  test "overlapping cubes" do
    assert AdventOfCode.Puzzles.Year2021.Day22.is_overlapping({{0, 5}}, {{0, 5}})
    assert AdventOfCode.Puzzles.Year2021.Day22.is_overlapping({{0, 5}}, {{-1, 5}})
    assert AdventOfCode.Puzzles.Year2021.Day22.is_overlapping({{0, 5}}, {{1, 5}})
    assert AdventOfCode.Puzzles.Year2021.Day22.is_overlapping({{0, 5}}, {{0, 4}})
    assert AdventOfCode.Puzzles.Year2021.Day22.is_overlapping({{0, 5}}, {{0, 6}})
    assert AdventOfCode.Puzzles.Year2021.Day22.is_overlapping({{0, 2}}, {{2, 4}})
    assert AdventOfCode.Puzzles.Year2021.Day22.is_overlapping({{2, 4}}, {{0, 2}})
    assert AdventOfCode.Puzzles.Year2021.Day22.is_overlapping({{0, 0}}, {{0, 2}})
    assert AdventOfCode.Puzzles.Year2021.Day22.is_overlapping({{1, 3}}, {{2, 2}})
    refute AdventOfCode.Puzzles.Year2021.Day22.is_overlapping({{0, 0}}, {{1, 2}})
    refute AdventOfCode.Puzzles.Year2021.Day22.is_overlapping({{1, 2}}, {{-1, 0}})
  end
  ...
  test "substract cubes" do
    ...
    assert AdventOfCode.Puzzles.Year2021.Day22.substract(left, right) == expected
  end

  test "solve 1st puzzle" do
    assert AdventOfCode.Puzzles.Year2021.Day22.solve1(@test_steps_small) == 39
    assert AdventOfCode.Puzzles.Year2021.Day22.solve1(@test_steps_medium) == 590_784
  end

  test "solve 2nd puzzle" do
    assert AdventOfCode.Puzzles.Year2021.Day22.solve2(@test_steps_large) == 2_758_514_936_282_235
  end
end
