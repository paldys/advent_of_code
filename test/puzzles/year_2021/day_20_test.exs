defmodule AdventOfCode.Puzzles.Year2021.Day20Test do
  use ExUnit.Case
  ...
  test "solve 1st puzzle" do
    assert AdventOfCode.Puzzles.Year2021.Day20.solve1(load_test_image()) == 35
  end

  @tag :slow
  test "solve 2nd puzzle" do
    assert AdventOfCode.Puzzles.Year2021.Day20.solve2(load_test_image()) == 3351
  end
  ...
  defp load_test_image() do
    ...
    AdventOfCode.Puzzles.Year2021.Day20.parse(test_input)
  end
end
