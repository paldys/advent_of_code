defmodule AdventOfCode.Puzzles.Day16Test do
  ...
  test "decode operator with length" do
    ...
    assert decoded_packet == {:operator, 1, [{:literal, 2, 20}, {:literal, 6, 10}]}
  end
  ...
  test "decode operator with count" do
    ...
    assert decoded_packet ==
             {:operator, 7, [{:literal, 1, 3}, {:literal, 4, 2}, {:literal, 2, 1}]}
  end
  ...
  test "solve 2nd puzzle" do
    assert AdventOfCode.Puzzles.Day16.solve2(nil) == nil
  end
end
