defmodule AdventOfCode.Puzzles.Day11Test do
  use ExUnit.Case
  ...
  test "solve 1st puzzle for 10 steps" do
    assert AdventOfCode.Puzzles.Day11.solve1(@test_energy_levels, 10) == 204
  end

  test "solve 1st puzzle" do
    assert AdventOfCode.Puzzles.Day11.solve1(@test_energy_levels) == 1656
  end
