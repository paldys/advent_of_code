defmodule AdventOfCode.Puzzles.Year2021.Day01 do
  @moduledoc """
  --- Day 1: Sonar Sweep ---
  ...
  sweep report (your puzzle input) appears: each line is a measurement of
  the sea floor depth as the sweep looks further and further away from
  the submarine.
  ...
  def solve1(measurements, increases \\ 0)

  def solve1([], increases) do
    increases
  end

  def solve1([_], increases) do
    increases
  end

  def solve1([head | tail], increases) when head < hd(tail) do
    solve1(tail, increases + 1)
  end

  def solve1([_ | tail], increases) do
    solve1(tail, increases)
  end

  def solve2(measurements) when measurements.length < 4 do
    0
  end

  def solve2(measurements) do
    {[sw_1, sw_2, sw_3], rest} = Enum.split(measurements, 3)
    _solve2(sw_1, sw_2, sw_3, rest, 0)
  end

  defp _solve2(_, _, _, [], increases) do
    increases
  end

  defp _solve2(sw_1, sw_2, sw_3, [head | tail], increases) when sw_1 < head do
    _solve2(sw_2, sw_3, head, tail, increases + 1)
  end

  defp _solve2(_, sw_2, sw_3, [head | tail], increases) do
    _solve2(sw_2, sw_3, head, tail, increases)
  end
end
