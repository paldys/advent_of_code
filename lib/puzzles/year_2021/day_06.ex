defmodule AdventOfCode.Puzzles.Year2021.Day06 do
  @moduledoc """
  --- Day 6: Lanternfish ---
  ...
  def solve1(timers, days \\ 80) do
    grouped_timers = Enum.frequencies(timers)

    updated_timers = simulate_days(grouped_timers, days)

    Map.to_list(updated_timers)
