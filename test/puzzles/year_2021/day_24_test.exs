defmodule AdventOfCode.Puzzles.Year2021.Day24Test do
  use ExUnit.Case

  alias AdventOfCode.Puzzles.Year2021.Day24
  ...
  test "parse input" do
    ...
    assert AdventOfCode.Puzzles.Year2021.Day24.parse(test_input) == [
             {:inp, :a},
             {:add, :a, :b},
             {:mul, :a, -2},
             {:div, :a, :b},
  ...
  test "solve 1st puzzle" do
    assert AdventOfCode.Puzzles.Year2021.Day24.solve1([
             {:inp, :w},
             {:mul, :z, 0},
             {:add, :z, :w},
             {:div, :z, 9}
  ...
  test "solve 2nd puzzle" do
    assert AdventOfCode.Puzzles.Year2021.Day24.solve2([
             {:inp, :w},
             {:mul, :z, 0},
             {:add, :z, :w},
             {:mod, :z, 2}
