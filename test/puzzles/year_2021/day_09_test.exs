defmodule AdventOfCode.Puzzles.Year2021.Day09Test do
  use ExUnit.Case
  ...
  test "solve 1st puzzle" do
    assert AdventOfCode.Puzzles.Year2021.Day09.solve1(@test_heightmap) == 15
  end

  test "solve 2nd puzzle" do
    assert AdventOfCode.Puzzles.Year2021.Day09.solve2(@test_heightmap) == 1134
  end
end
